...
<h3 align="center">DevOps Engineering Trainee @ PORIDHI.IO | Skilled in AWS, GCP, Azure, Docker, Kubernetes, Terraform, Python, Git & GitHub, CI/CD, Linux Aspiring | Cloud Enthusiast | Continuous Learner</h3>
